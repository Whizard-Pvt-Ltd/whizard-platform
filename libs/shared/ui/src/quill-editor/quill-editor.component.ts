...
import {
  ...
  ViewChild, ViewEncapsulation, forwardRef, inject, input, signal,
} from '@angular/core';
...
@Component({
  ...
  styles: [`
    /* ── Host ──────────────────────────────────────────────────── */
    whizard-quill-editor { display: block; }
    ...
    .qe-wrapper:focus-within {
      ...
      box-shadow: 0 0 0 2px color-mix(in srgb, var(--wrcf-accent, #00BFFF) 25%, transparent);
    }
    ...
    .qe-toolbar-visible .qe-toggle {
      ...
      border-color: var(--wrcf-accent, #00BFFF);
      background: color-mix(in srgb, var(--wrcf-accent, #00BFFF) 10%, var(--wrcf-bg-secondary, #0F253F));
    }
    ...
    .qe-wrapper .ql-stroke-mitter { stroke: var(--wrcf-text-secondary, #7F94AE); }
    .qe-wrapper .ql-fill           { fill:   var(--wrcf-text-secondary, #7F94AE); }
    .qe-wrapper .ql-picker          { color:  var(--wrcf-text-secondary, #7F94AE); }
    ...
    .qe-wrapper .ql-picker-item { color: var(--wrcf-text-primary, #E8F0FA); }
    ...
    .qe-wrapper .ql-tooltip::before  { color: var(--wrcf-text-secondary, #7F94AE); }
    ...
    /* ── Readonly mode ─────────────────────────────────────────── */
    .qe-readonly .ql-toolbar    { display: none !important; }
    .qe-readonly .ql-container  { border-radius: 8px; }
    .qe-readonly .ql-editor     { padding-right: 16px; cursor: default; }
    ...
    .qe-view .ql-toolbar          { display: none !important; }
    ...
    .qe-view .ql-editor.ql-blank::before { display: none; }
  `],
  providers: [
...
export class QuillEditorComponent implements ControlValueAccessor, AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(): void {
    ...
    this.quill = new Quill(this.containerRef.nativeElement, {
      ...
      modules: {
        toolbar: (this.readonly() || this.view()) ? false : [
