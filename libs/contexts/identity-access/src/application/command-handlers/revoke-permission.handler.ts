import type { RevokePermissionCommand } from '../commands/revoke-permission.command';
import type { RevokePermissionResponseDto } from '../dto/responses/revoke-permission.response.dto';
...
export class RevokePermissionHandler {
  ...
  async execute(command: RevokePermissionCommand): Promise<RevokePermissionResponseDto> {
    ...
    return this.unitOfWork.execute(async () => {
      ...
      return {
        success: true,
        message: 'RevokePermission executed.',
        data: {}
      };
    });
  }
