import type { SuspendProvisionedAccessCommand } from '../commands/suspend-provisioned-access.command';
import type { SuspendProvisionedAccessResponseDto } from '../dto/responses/suspend-provisioned-access.response.dto';
...
export class SuspendProvisionedAccessHandler {
  constructor(
  ...
  async execute(command: SuspendProvisionedAccessCommand): Promise<SuspendProvisionedAccessResponseDto> {
    ...
    return this.unitOfWork.execute(async () => {
      ...
      return {
        success: true,
        message: 'SuspendProvisionedAccess executed.',
        data: {}
      };
    });
  }
