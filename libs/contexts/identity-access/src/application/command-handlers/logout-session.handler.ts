import type { LogoutSessionCommand } from '../commands/logout-session.command';
import type { LogoutSessionResponseDto } from '../dto/responses/logout-session.response.dto';
...
export class LogoutSessionHandler {
  ...
  async execute(command: LogoutSessionCommand): Promise<LogoutSessionResponseDto> {
    ...
    return this.unitOfWork.execute(async () => {
      ...
      return {
        success: true,
        message: 'LogoutSession executed.',
        data: {}
      };
    });
  }
