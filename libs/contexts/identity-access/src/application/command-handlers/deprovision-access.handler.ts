import type { DeprovisionAccessCommand } from '../commands/deprovision-access.command';
import type { DeprovisionAccessResponseDto } from '../dto/responses/deprovision-access.response.dto';
...
export class DeprovisionAccessHandler {
  constructor(
  ...
  async execute(command: DeprovisionAccessCommand): Promise<DeprovisionAccessResponseDto> {
    ...
    return this.unitOfWork.execute(async () => {
      ...
      return {
        success: true,
        message: 'DeprovisionAccess executed.',
        data: {}
      };
    });
  }
