import type { CreateIdentityProviderCommand } from '../commands/create-identity-provider.command';
import type { CreateIdentityProviderResponseDto } from '../dto/responses/create-identity-provider.response.dto';
...
export class CreateIdentityProviderHandler {
  constructor(
  ...
  async execute(command: CreateIdentityProviderCommand): Promise<CreateIdentityProviderResponseDto> {
    ...
    return this.unitOfWork.execute(async () => {
      ...
      return {
        success: true,
        message: 'CreateIdentityProvider executed.',
        data: {}
      };
    });
  }
