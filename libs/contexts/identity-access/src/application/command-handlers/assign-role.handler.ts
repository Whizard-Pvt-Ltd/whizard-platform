import type { AssignRoleCommand } from '../commands/assign-role.command';
import type { AssignRoleResponseDto } from '../dto/responses/assign-role.response.dto';
...
export class AssignRoleHandler {
  ...
  async execute(command: AssignRoleCommand): Promise<AssignRoleResponseDto> {
