import type { GrantPermissionCommand } from '../commands/grant-permission.command';
import type { GrantPermissionResponseDto } from '../dto/responses/grant-permission.response.dto';
...
export class GrantPermissionHandler {
  ...
  async execute(command: GrantPermissionCommand): Promise<GrantPermissionResponseDto> {
    ...
    return this.unitOfWork.execute(async () => {
      ...
      return {
        success: true,
        message: 'GrantPermission executed.',
        data: {}
      };
    });
  }
