import type { UpdateSsoRoleMappingCommand } from '../commands/update-sso-role-mapping.command';
import type { UpdateSsoRoleMappingResponseDto } from '../dto/responses/update-sso-role-mapping.response.dto';
...
export class UpdateSsoRoleMappingHandler {
  constructor(
  ...
  async execute(command: UpdateSsoRoleMappingCommand): Promise<UpdateSsoRoleMappingResponseDto> {
    ...
    return this.unitOfWork.execute(async () => {
      ...
      return {
        success: true,
        message: 'UpdateSsoRoleMapping executed.',
        data: {}
      };
    });
  }
