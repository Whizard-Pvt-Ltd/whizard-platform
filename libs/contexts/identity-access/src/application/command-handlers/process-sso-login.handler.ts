import type { ProcessSsoLoginCommand } from '../commands/process-sso-login.command';
import type { ProcessSsoLoginResponseDto } from '../dto/responses/process-sso-login.response.dto';
...
export class ProcessSsoLoginHandler {
  constructor(
  ...
  async execute(command: ProcessSsoLoginCommand): Promise<ProcessSsoLoginResponseDto> {
    ...
    return this.unitOfWork.execute(async () => {
      ...
      return {
        success: true,
        message: 'ProcessSsoLogin executed.',
        data: {}
      };
    });
  }
