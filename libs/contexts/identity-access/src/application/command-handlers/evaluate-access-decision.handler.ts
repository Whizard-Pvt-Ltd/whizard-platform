import type { EvaluateAccessDecisionCommand } from '../commands/evaluate-access-decision.command';
...
export class EvaluateAccessDecisionHandler {
  ...
  async execute(command: EvaluateAccessDecisionCommand): Promise<EvaluateAccessDecisionResponseDto> {
    ...
    return this.unitOfWork.execute(async () => {
      ...
      return {
        success: true,
        message: 'EvaluateAccessDecision executed.',
        data: {}
      };
    });
  }
